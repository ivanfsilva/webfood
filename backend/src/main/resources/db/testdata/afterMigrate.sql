...
values (1, ''Thai Gourmet'', 10, 1, utc_timestamp, utc_timestamp, true, true, 1, ''38400 - 999 '',
...
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values (''Bife Ancho'', ''Corte macio e suculento, com dois dedos de espessura,
        retirado da parte dianteira do contrafilé'', 79, 1, 4);
insert into produto (nome, descricao, preco, ativo, restaurante_id)
values (''T-Bone'', ''Corte muito saboroso, com um osso em formato de T,
        sendo de um lado o contrafilé e do outro o filé mignon'', 89, 1, 4);
